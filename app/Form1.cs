    ...
    public partial class Form1 : Form
{
    ...
    public Form1()
    {
        ...
        chkAz.CheckedChanged += (s, e) => SendConfiguration();
    ...
    private void SendConfiguration()
    {
        ...
        string jsonCmd = $"{{\"p\":{numP.Value}, \"n\":{numN.Value}, \"Ax\":{ax}, \"Ay\":{ay}, \"Az\":{az}, \"SD0\":{sd0}, \"SD1\":{sd1}, \"D6\":{d6}, \"D7\":{d7}, \"DB\":{db}, \"DV\":{dv}}}\n";
    ...
    private void ProcessSerialJsonMessage(string data)
    {
        ...
        try
        {
            ...
            string[] sensoresPossiveis = { "Ax", "Ay", "Az", "SD0", "SD1", "D6", "D7", "DB", "DV" };
            ...
            bool anySensorEnabled = chkAx.Checked || chkAy.Checked || chkAz.Checked || chkSD0.Checked || chkSD1.Checked || chkD6.Checked || chkD7.Checked || chkDB.Checked || chkDV.Checked;
